...
DEPS = json kvc riak_pipe cowboy jiffy jsx erlydtl brod
dep_json = git https://github.com/hio/erlang-json.git
dep_kvc = git https://github.com/etrepum/kvc.git
dep_riak_pipe = git https://github.com/basho/riak_pipe 2.1.0
...
dep_brod = git https://github.com/klarna/brod.git 1.1
